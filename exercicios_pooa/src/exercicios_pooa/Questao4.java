...
public class Questao4 
{
	...
	public static void main(String[] args)
	{
		...
		if (v1 >= v2 && v1 >= v3) // se v1 for maior que v2 e maior que v3
			System.out.printf("MAIOR = %d%n", v1);// imprima que o maior é v1
		else if (v2 >= v1 && v2 >= v3)// se v2 for maior que v1 e maior que v3
			System.out.printf("MAIOR = %d%n", v2);// imprima que o maior é v2
		else
			System.out.printf("MAIOR =  %d%n", v3);// se n imprima que o maior é v3
		
		// condição do menor
		if (v1 <= v2 && v1 <= v3)// se v1 for menor que v2 e menor que v3
			System.out.printf("MENOR = %d%n", v1);// imprima que o menor é v1
		else if (v2 <= v1 && v2 <= v3)// se v2 for menor que v1 e menor que v3
			System.out.printf("MENOR = %d%n", v2);// imprima que o menor é v2
		else
			System.out.printf("MENOR =  %d%n", v3);//se n imprima que o menor é v3
